...
1. Get a paclet archive file of Q3 from the [Releases](https://github.com/quantum-mob/Q3/releases). Note that a paclet archive file has file extension ".paclet" such as "Q3-3.8.2.paclet".
