...
<img align="Right" src="Q3/Assets/Images/EmblemQ3.png" width="30%"/>
</a>
...
The official Paclet name of this framework has been changed to `QuantumMob/Q3` following the convention of the [Wolfram Language Paclet Repository](https://resources.wolframcloud.com/PacletRepository/). To load Q3, use `Get["QuantumMob/Q3"]` or `Needs["QuantumMob/Q3"]` (usually it is autoloaded when WolframKernel starts). The primary context is now "QuantumMob\`Q3\`" (rather than previous "Q3\`").
