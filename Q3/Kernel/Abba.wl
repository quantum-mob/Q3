...
Q3General::summary = "A symbolic quantum simulation framework on quantum information systems, quantum many-body systems, and quantum spin systems.";

Q3General::local = "You are using a locally installed beta version of Q3.";
...
Q3Info[] := Module[
  ...
  Which[ 
    ...
    Message[Q3General::local]
  ];
  StringJoin["Q3 v", pac["Version"], " \[Copyright] 2020 ", Q3General::summary]
];
(**** </Q3Info> ****)
