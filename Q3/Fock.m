...
Print @ StringJoin[
  ...
  StringSplit["$Date: 2020-11-02 17:21:56+09 $"][[2]], ") ",
  "Mahn-Soo Choi"
 ]

If[ $VersionNumber < 11,
  Fock::old = "The package Fock requires Mathematica 11 or later.";
  Message[Fock::old];
 ]

Fock::usage = "Fock is a Mathematica package to help study quantum many-body systems.\nIt handles the complex Weyl and complex Clifford algebras and their representations on the Fock space. The complex Weyl algebra, physically describing Bosons, is generated by the Heisenberg's canonical conjugate operators or by the Bosonic creator and annihilators. The complex Clifford algebra, physically describing Fermions, is generated by the Dirac Fermion creators and annihilators or by the Majorana fermion operators."
...
Quisso`Fock`Private`symbs = Protect[Evaluate[$Context<>"*"]]

SetAttributes[Evaluate[Quisso`Fock`Private`symbs], ReadProtected]
